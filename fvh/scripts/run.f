...
-uvm +UVM_TESTNAME=simple_test +UVM_VERBOSITY=UVM_LOW
-sv +incdir+../verif
...
-sv ../verif/config/gaussian_blur_config_pkg.sv
-sv ../verif/agent/agent_pkg.sv
-sv ../verif/sequences/seq_pkg.sv
-sv ../verif/test_pkg.sv
-sv ../verif/gaussian_blur_if.sv
-sv ../verif/gaussian_blur_top.sv
