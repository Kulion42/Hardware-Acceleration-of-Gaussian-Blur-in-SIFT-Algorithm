...
add_files -norecurse {dsp_unit_mul_shift.vhd}
...
add_files -norecurse {adress_generation.vhd}
...
set_property xsim.view {/home/luka/sift-cpp-master/psds/tb/check_convolution_tb_behav.wcfg } [get_filesets sim_1]
set_property xsim.view {/home/luka/sift-cpp-master/psds/tb/check_gaussian_blur_behav.wcfg } [get_filesets sim_1]
set_property xsim.view {/home/luka/sift-cpp-master/psds/tb/check_top_model_behav.wcfg } [get_filesets sim_1]

set_property file_type {VHDL 2008} [get_files kernel_rom.vhd]
set_property file_type {VHDL 2008} [get_files convolute_loops.vhd]
