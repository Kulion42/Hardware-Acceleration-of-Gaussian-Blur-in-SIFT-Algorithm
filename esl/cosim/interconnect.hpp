...
class Interconnect : public sc_core::sc_module, public tlm::tlm_bw_transport_if<>, public tlm::tlm_fw_transport_if<>
{
	public:
		Interconnect(sc_core::sc_module_name name);
		~Interconnect();
        
        tlm::tlm_initiator_socket<> ip_core_socket;
		tlm::tlm_target_socket<> cpu_socket;
